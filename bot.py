...
# --- FIREBASE SETUP ---
# আপনার serviceAccountKey.json ফাইলটি বটের ফোল্ডারে রাখুন
cred = credentials.Certificate("serviceAccountKey.json")
firebase_admin.initialize_app(cred, {'databaseURL': 'https://YOUR_DATABASE_URL.firebaseio.com/'})
...
def start(message): 
    ...
    db_ref.child(str(message.from_user.id)).update({"exists": True})
...
def broadcast(message):
    if str(message.from_user.id) == ADMIN_ID:
        ...
        bot.reply_to(message, "✅ মেসেজ পাঠানো সম্পন্ন হয়েছে।")
