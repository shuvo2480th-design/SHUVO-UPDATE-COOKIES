...
def make_box(lines):
    """একাধিক লাইনকে বক্স আকারে সাজায় (plain text, কোনো HTML/pre না — তাই Telegram নিজে থেকে Copy বাটন যোগ করবে না)"""
...
def otp_result_markup(otp, price=None):
    ...
    if price is not None:
        rows.append([make_button(f"💰 ADD BALANCE {price:.2f} ৳", callback_data="noop", style="primary")])
    return build_inline_keyboard(rows)
...
def process_number(message, edit_msg=None, service_name="Unknown", rid=None):
    ...
    # ✅ ফ্ল্যাগ + নাম্বার + সার্ভিস ট্যাগ বক্স
