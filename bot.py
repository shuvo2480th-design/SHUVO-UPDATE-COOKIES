...
def make_box(lines):
    """একাধিক লাইনকে ছোট, কমপ্যাক্ট বক্স আকারে সাজায় (ফ্ল্যাগ ইমুজি চওড়া রেন্ডার হয় বলে বর্ডারে সামান্য এক্সট্রা প্যাডিং যোগ করা হয়েছে, যাতে বর্ডার শেষ পর্যন্ত টেক্সট কভার করে)"""
    width = (max(len(l) for l in lines) if lines else 0) + 2
    top    = "╔" + "═" * width + "╗"
    bottom = "╚" + "═" * width + "╝"
